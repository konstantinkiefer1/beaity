...
const list = [
  {
    ...
    name: "Lisa Müller",
    text: "Ich bin so begeistert von meinem neuen Look! Das Permanent Make-up ist einfach perfekt. Vielen Dank!",
    type: refTypes.twitter,
    link: "https://twitter.com/beauty_queen",
    img: "https://pbs.twimg.com/profile_images/1504863683574599681/9k7PqDTA_400x400.jpg",
  },
  {
    username: "lashes_love",
    name: "Anna Schmidt",
    text: "Die Wimpern sehen unglaublich aus! Ich bekomme ständig Komplimente. Absolut empfehlenswert!",
    type: refTypes.twitter,
    link: "https://twitter.com/lashes_love",
  },
  {
    username: "perfectbrows",
    name: "Miriam Weber",
    text: "Meine Augenbrauen sind jetzt perfekt definiert und ich spare morgens so viel Zeit. Danke!",
    type: refTypes.productHunt,
    link: "https://www.producthunt.com/products/your-product/reviews?review=123456",
  },
  {
    name: "Sarah",
    text: "Einfach fantastisch! Ich hätte nie gedacht, dass meine Wimpern so schön sein können.",
    type: refTypes.other,
  },
  {
    username: "happy_customer",
    name: "Julia Fischer",
    text: "Das Permanent Make-up hat meine Erwartungen übertroffen. Es sieht so natürlich aus!",
    type: refTypes.productHunt,
    link: "https://www.producthunt.com/posts/your-product?comment=123456",
  },
  {
    username: "glam_girl",
    name: "Sophie Becker",
    text: "Ein wahrer Game Changer! Ich fühle mich so viel selbstbewusster mit meinen neuen Wimpern und Brauen.",
    type: refTypes.twitter,
    link: "https://twitter.com/glam_girl/status/123456789?s=20",
  },
  {
    name: "Nina",
    text: "Die besten Ergebnisse, die ich je hatte. Meine Brauen und Wimpern sehen einfach fantastisch aus!",
    type: refTypes.other,
  },
  {
    name: "Lisa Müller",
    text: "Das Team ist super freundlich und professionell. Ich bin jedes Mal begeistert von den Ergebnissen.",
    videoPoster: "/Screenshot_14.png",
    videoSrc: "IMG_4155.mov",
    videoHeight: 250,
    videoWidth: 500,
    videoType: "video/mp4",
    type: refTypes.video,
  ...
  {
    username: "brow_expert",
    name: "Clara Wagner",
    text: "Ich habe noch nie so schöne Augenbrauen gehabt. Das Ergebnis ist einfach perfekt!",
    type: refTypes.twitter,
  },
  {
    username: "lash_diva",
    name: "Laura Meier",
    text: "Die Behandlung war super angenehm und das Ergebnis ist umwerfend. Absolut empfehlenswert!",
    type: refTypes.productHunt,
    link: "https://www.producthunt.com/posts/your-product?comment=123457",
  },
  // The last testimonial is featured on big devices (span 2 columns + big font) 👇
  {
    username: "beauty_guru",
    name: "Hannah Braun",
    text: "Die besten Wimpern- und Brauenbehandlungen, die ich je hatte. Ich werde definitiv wiederkommen! Vielen Dank für den tollen Service.",
    type: refTypes.twitter,
    link: "https://twitter.com/beauty_guru/status/123456789?s=20",
  },
];
        ...
        <div className="flex flex-col text-center w-full mb-20">
          <div className="mb-8">
            <h2 className="sm:text-5xl text-4xl font-extrabold text-base-content">
              Über 112 glückliche Kunden!
            </h2>
          </div>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-base-content/80">
            Das sagen meine Kunden über {config.appName}.
          </p>
        </div>
